// Letter Dispatcher — minimal offline service worker.
//
// Two jobs:
...
//     button (see app/index.html) needs that event to trigger the native
...
const CACHE_NAME = "letter-dispatcher-shell-v1";
