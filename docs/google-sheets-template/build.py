...
headers = ["Name", "Email", "Office address", "Group", "Phone (optional)"]
col_widths = [24, 30, 34, 18, 20]
...
examples = [
    ["Jane Doe (example)", "jane.doe@example.com", "500 Market St, San Francisco", "Sales", "+1 415 555 0101"],
    ["John Smith (example)", "john.smith@example.com", "12 rue de Rivoli, Paris", "Support", "+33 1 42 60 12 34"],
]
